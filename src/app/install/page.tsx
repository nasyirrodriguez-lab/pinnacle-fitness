...
export const metadata: Metadata = {
  title: 'Add The Worx to your home screen | The Worx',
  description:
    'Install The Worx as an app on your phone for one-tap check-in. Step-by-step instructions for iPhone Safari and Android Chrome.',
