  ...
  return (
    <div className="bg-[#E8E4DC] min-h-screen pt-20">
      ...
      <div className="py-20 px-6 sm:px-12 max-w-6xl mx-auto">
        ...
        <h1 className="font-serif text-5xl sm:text-7xl text-[#3A3733] leading-tight">
          Train with <em className="text-[#3A3733] not-italic font-serif">intention</em>.
        </h1>
      ...
      {/* Program list */}
      <div className="border-t border-[#CCC8C0] divide-y divide-[#CCC8C0]">

        {/* Strength Training */}
        <div className="py-10 px-6 sm:px-12 max-w-6xl mx-auto flex items-start gap-8">
          <div className="w-16 h-16 rounded-xl bg-[#CCC8C0] flex items-center justify-center text-sm font-mono font-semibold text-[#6B6560] flex-shrink-0">
            ST
          </div>
          <div className="flex-1">
            <h2 className="font-serif text-2xl text-[#3A3733] mb-3">Strength Training</h2>
        ...
        <div className="bg-[#1F3D2B]">
          <div className="py-10 px-6 sm:px-12 max-w-6xl mx-auto flex items-start gap-8">
            <div className="w-16 h-16 rounded-xl bg-[#3A3733] flex items-center justify-center text-sm font-mono font-semibold text-white flex-shrink-0">
              SP
            </div>
            <div className="flex-1">
              <p className="text-xs font-medium tracking-[0.15em] uppercase text-[#3A3733] mb-3">Athlete Program</p>
        ...
        <div className="py-10 px-6 sm:px-12 max-w-6xl mx-auto flex items-start gap-8">
          ...
          <div className="flex-1">
            <h2 className="font-serif text-2xl text-[#3A3733] mb-3">Bootcamps</h2>
            <p className="text-[#6B6560] leading-relaxed max-w-2xl">
        ...
        <div className="py-10 px-6 sm:px-12 max-w-6xl mx-auto flex items-start gap-8">
          ...
          <div className="flex-1">
            <h2 className="font-serif text-2xl text-[#3A3733] mb-3">Open Gym</h2>
            <p className="text-[#6B6560] leading-relaxed max-w-2xl">
      ...
      <div className="bg-[#1F3D2B] py-14 px-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <Link
            href="/pricing"
            className="bg-[#3A3733] text-white rounded-full px-7 py-3 text-sm font-medium hover:bg-[#2a2825] transition-colors whitespace-nowrap flex-shrink-0"
          >
            See memberships
          </Link>
        </div>
