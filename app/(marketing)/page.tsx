    ...
    <>
      ...
      <section className="bg-[#1F3D2B] py-4 px-6 text-center">
        <p className="text-white/90 text-sm">
          ...
          <Link href="/free-trial" className="underline text-[#C85C2D] hover:text-[#e07050] transition-colors font-medium">
            Book now →
          </Link>
        </p>
      </section>
      ...
      <section className="bg-white py-20 px-6 sm:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <div>
              <p className="text-xs font-medium tracking-[0.15em] uppercase text-[#6B6560] mb-2">Instagram</p>
              <h2 className="font-serif text-3xl sm:text-4xl text-[#1C1A17]">Follow us @pinnaclefitnessandfootball</h2>
            </div>
            <a
              href="https://www.instagram.com/pinnaclefitnessandfootball"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex items-center gap-2 border border-[#E8E3D9] text-[#6B6560] rounded-full px-5 py-2.5 text-sm hover:border-[#C85C2D] hover:text-[#C85C2D] transition-colors"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="aspect-square rounded-xl overflow-hidden bg-[#F5F0E8] relative group block"
              >
                <img
          ...
          <div className="mt-6 text-center sm:hidden">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border border-[#E8E3D9] text-[#6B6560] rounded-full px-5 py-2.5 text-sm hover:border-[#C85C2D] hover:text-[#C85C2D] transition-colors"
            >
              Follow on Instagram
            </a>
          </div>
